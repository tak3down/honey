...
const API_BASE = 'http://localhost:25720/api';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-16">
        <div className="flex items-center space-x-4">
          <div
              className="bg-gradient-to-r from-yellow-500 to-orange-600 bg-clip-text text-transparent">
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4">
          <div
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-slate-400 text-lg">Sprawdź swoją wiedzę geograficzną z flagami z
                całego
                świata</p>
            </div>
